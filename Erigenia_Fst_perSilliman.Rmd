...
combined_noMD
```
need a genind, convert no md vcf to genind using VCFtools (manual/site: https://vcftools.github.io/man_latest.html)
...
may also need to use hierfstat or similar to generate non-comparative Fst's per pop for reporting in a table.
